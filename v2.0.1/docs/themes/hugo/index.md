...
[Open the Docsy example](/brand/v2.0.1/examples/hugo-docsy/)
...
[Docsy example](/brand/v2.0.1/examples/hugo-docsy/).
...
text remains blue, such as the [token reference](/brand/v2.0.1/docs/tokens/),
...
[Open the Hextra example](/brand/v2.0.1/examples/hugo-hextra/)
to inspect the documented patterns in a working site.
...
For a complete local kitchen-sink implementation, see the
[Hextra example](/brand/v2.0.1/examples/hugo-hextra/).
It is built manually with the

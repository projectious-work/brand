...
[foundations](/brand/v2.0.1/docs/foundations/). They are **MIT-licensed** —
the values are free to use, the marks are not. See
[Licensing](/brand/v2.0.1/docs/governance/licensing/).
...
- **Colour** — the seven named aliases. The full 12-step scales are documented
  on the [Colour page](/brand/v2.0.1/docs/foundations/color/); the token file

...
<div class="pj-demo"><div class="pj-demo__label">Digital vCard</div>
...
<div class="pj-demo"><div class="pj-demo__label">Paper card — white stock, accent on the leading edge</div>
  <div class="pj-demo__body pj-demo__body--stack">
    
<div class="pj-vcard pj-vcard--paper">
  <span class="pj-lockup" style="margin-bottom:.75rem"><svg viewBox="0 0 40 40" role="img" aria-label="projectious mark" class="projectious-mark pj-mark" style="width:28px;height:28px">
...
<span class="pj-wm pj-wm--on-light" style="font-size:13px">projectious<span class="pj-wm__ext"> · work</span></span></span>
  <div class="pj-vcard__name">Bernhard Gerlach</div>
  <div class="pj-vcard__role">Cloud · Agile · Agentic AI</div>
  <div class="pj-vcard__row" style="margin-top:.625rem">info@projectious.work</div>
  <div class="pj-vcard__row">projectious.work</div>
...
[signature](/brand/v2.1.0/docs/collateral/email-signature/) uses.
...
<div class="alert alert-info" role="alert"><div class="h4 alert-heading" role="heading">This specimen is white in both modes, deliberately</div>
...
- Use the [monochrome mark](/brand/v2.1.0/docs/logo/usage/) — no accent on
...
<div class="alert alert-warning" role="alert"><div class="h4 alert-heading" role="heading">The CMYK column is a starting point, not a specification</div>

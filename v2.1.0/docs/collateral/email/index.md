...
The [signature](/brand/v2.1.0/docs/collateral/email-signature/) covers the
...
| | Source |
|---|---|
| **Newsletter** | [`brand/examples/email-newsletter.html`](/brand/v2.1.0/downloads/examples/email-newsletter.html) |
...
[1100px measure](/brand/v2.1.0/docs/foundations/space-shape-motion/). Below
...
- **The fill is `#cc4528`, not `#E05232`.** White on the identity accent is
  ...
  [solid controls in the interface](/brand/v2.1.0/docs/interface/components/),
...
- **44px tall.** A mail is read on a phone more often than not, so the
  [touch floor](/brand/v2.1.0/docs/foundations/responsive/) is the binding
  constraint.
...
The [signature's colour table](/brand/v2.1.0/docs/collateral/email-signature/)
...
the [signature page](/brand/v2.1.0/docs/collateral/email-signature/), not an
unsubscribe.

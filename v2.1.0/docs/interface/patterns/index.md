...
[Components](/brand/v2.1.0/docs/interface/components/) answers "what does a
...
the screen — [one accent per view](/brand/v2.1.0/docs/interface/components/)
...
pattern; see [Responsive](/brand/v2.1.0/docs/foundations/responsive/).
...
Each card is a [`pj-stat`](/brand/v2.1.0/docs/interface/components/) — the
...
- **Primary** is the record set — a [table](/brand/v2.1.0/docs/interface/components/)
...
[**Dashboard mockup**](/brand/v2.1.0/downloads/examples/dashboard.dc.html) — a client
...
[**Mobile onboarding**](/brand/v2.1.0/downloads/examples/mobile-onboarding.dc.html) —
...
[44px floor](/brand/v2.1.0/docs/foundations/responsive/) applies regardless.

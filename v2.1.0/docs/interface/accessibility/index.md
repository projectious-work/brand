...
on [Colour](/brand/v2.1.0/docs/foundations/color/), the 44px touch floor on
[Responsive](/brand/v2.1.0/docs/foundations/responsive/), the focus trap on
...
[page shell](/brand/v2.1.0/docs/interface/patterns/) is therefore authored as
...
[stacked mobile layout](/brand/v2.1.0/docs/foundations/responsive/) exposes:
...
[Icons](/brand/v2.1.0/docs/interface/icons/).
...
[Multi-level headers](/brand/v2.1.0/docs/interface/components/) need
`scope="colgroup"` on the group row.

## Motion and preference

The [motion rules](/brand/v2.1.0/docs/foundations/space-shape-motion/) are an

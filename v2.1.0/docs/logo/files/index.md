...
| Asset | Link |
|---|---|
| SVG — light | [icon-light.svg](/brand/v2.1.0/downloads/logo/svg/icon-light.svg) |
| SVG — dark | [icon-dark.svg](/brand/v2.1.0/downloads/logo/svg/icon-dark.svg) |
| SVG — mono black | [icon-mono-black.svg](/brand/v2.1.0/downloads/logo/svg/icon-mono-black.svg) |
| SVG — mono white | [icon-mono-white.svg](/brand/v2.1.0/downloads/logo/svg/icon-mono-white.svg) |
| SVG — mono grey | [icon-mono-gray.svg](/brand/v2.1.0/downloads/logo/svg/icon-mono-gray.svg) |
...
[Licensing](/brand/v2.1.0/docs/governance/licensing/); you may not modify
them or use them to imply endorsement. See also the
[Trademark guidelines](/brand/v2.1.0/docs/governance/trademark/).
</div>

...
- [Foundations](https://projectious-work.github.io/brand/v3.0.0/docs/foundations/index.md) — The primitives — colour, typography, spacing, shape, and motion. Everything else composes from these.
- [Logo](https://projectious-work.github.io/brand/v3.0.0/docs/logo/index.md) — The mark, the four lockups, and the rules that keep them legible.
- [Interface](https://projectious-work.github.io/brand/v3.0.0/docs/interface/index.md) — The foundations applied to screens — components, code surfaces, dark mode, icons, and forms.
- [Themes](https://projectious-work.github.io/brand/v3.0.0/docs/themes/index.md) — Configuration of theme frameworks for use with the projectious.work brand system.
- [Portfolio](https://projectious-work.github.io/brand/v3.0.0/docs/portfolio/index.md) — Truthful status, social-preview, diagram, and demo patterns.
- [Media](https://projectious-work.github.io/brand/v3.0.0/docs/media/index.md) — Motion, audio, video, photography, and presentation guidance.
- [Collateral](https://projectious-work.github.io/brand/v3.0.0/docs/collateral/index.md) — Artefacts that leave the product — cards, signatures, and social imagery.
- [Governance](https://projectious-work.github.io/brand/v3.0.0/docs/governance/index.md) — Licensing, trademark, the pre-launch legal assessment, and per-asset provenance.
- [Tokens](https://projectious-work.github.io/brand/v3.0.0/docs/tokens/index.md) — Machine-readable exports of the design values, and how to consume them.
- [AI consumption](https://projectious-work.github.io/brand/v3.0.0/docs/ai/index.md) — A versioned map from brand use cases to their normative documentation and generated machine-readable material.

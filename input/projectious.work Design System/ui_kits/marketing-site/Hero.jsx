    ...
    <section style={{
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative' }}>
        <div style={{
          ...
          letterSpacing: '0.12em', textTransform: 'uppercase', color: '#ea7558',
          marginBottom: 24
        }}>Cloud · Agile · Agentic AI</div>
        <h1 style={{
          fontFamily: 'var(--font-heading)', fontWeight: 800, fontSize: 72,
          lineHeight: 1.05, letterSpacing: '-1.5px', color: '#fff', margin: 0,
          maxWidth: 820
        }}>Redesigning work.</h1>
        <p style={{
          fontFamily: 'var(--font-body)', fontSize: 19, lineHeight: 1.6,
          color: '#97a8b8', marginTop: 28, maxWidth: 620
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 36 }}>
          ...
          <button style={{
            ...
            background: 'transparent', color: '#c5daf0',

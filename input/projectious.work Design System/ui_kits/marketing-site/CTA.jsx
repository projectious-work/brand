export function CTA() {
  return (
    <section style={{
      background: 'var(--fg-1)', padding: '80px 32px', position: 'relative', overflow: 'hidden'
    }}>
      <div style={{
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 32, position: 'relative' }}>
        <div>
          <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: 36, color: 'var(--surface)', margin: 0, letterSpacing: '-0.4px' }}>Ready to redesign how you work?</h2>
        ...
        <button style={{
          ...
          color: 'var(--surface)', background: 'var(--color-accent-solid)', cursor: 'pointer', flexShrink: 0

...
> Reference implementations for product shells, documentation, terminals, and portable brand surfaces.
...
- [Hugo](https://projectious-work.github.io/brand/v3.0.2/docs/themes/hugo/index.md) — Apply the projectious.work brand through the supported Hugo theme, its public extension points, and site-owned content.
- [Terminal](https://projectious-work.github.io/brand/v3.0.2/docs/themes/terminal/index.md) — The default dark and optional light projectious.work terminal palettes, plus configuration for tmux, WezTerm, Kitty, Ghostty, iTerm2, and Zellij.

...
linkTitle: One-pager
weight: 35
description: The sales flier — one service, one page, one call to action.
---
...
| | Source |
|---|---|
| **Service flier** | [`brand/examples/flier.dc.html`]({{< siteurl "downloads/examples/flier.dc.html" >}}) — "Cloud migration accelerator" |

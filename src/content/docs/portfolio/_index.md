...
linkTitle: Portfolio
weight: 35
description: Truthful status, social-preview, diagram, and demo patterns.
---
...
- [Documents]({{< relref "/docs/portfolio/documents" >}}) define the one-page CV, proposal, and memo pattern.

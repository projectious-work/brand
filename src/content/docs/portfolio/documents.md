...
linkTitle: Documents
weight: 40
description: The one-page document pattern — CV, proposal, memo — and how it paginates.
---
...
| | Source |
|---|---|
| **Resume / CV** | [`brand/examples/resume.dc.html`]({{< siteurl "downloads/examples/resume.dc.html" >}}) |

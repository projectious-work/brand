...
weight: 40
description: The four breakpoints, how the 12-column grid collapses, touch-target sizes, and the mobile navigation pattern.
---
...
[`brand/tokens/variables.css`]({{< siteurl "downloads/tokens/variables.css" >}}) and
normative here:
...
- An **application** has a small, flat set of destinations — the
  [dashboard example]({{< siteurl "downloads/examples/dashboard.dc.html" >}}) has five.
...
[**Mobile onboarding**]({{< siteurl "downloads/examples/mobile-onboarding.dc.html" >}}) —
...
actions. It is the [dashboard]({{< siteurl "downloads/examples/dashboard.dc.html" >}})

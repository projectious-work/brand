...
{{< demo label="KPI row — value, overline label, delta with an explicit direction" variant="stack" >}}
...
[**Dashboard mockup**]({{< siteurl "downloads/examples/dashboard.dc.html" >}}) — a client

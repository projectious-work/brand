...
[foundations](/brand/v2.1.1/docs/foundations/). They are **MIT-licensed** —
the values are free to use, the marks are not. See
[Licensing](/brand/v2.1.1/docs/governance/licensing/).

## Downloads

| File | Format | Use |
|---|---|---|
| [`variables.css`](/brand/v2.1.1/downloads/tokens/variables.css) | CSS custom properties | Any web project |
| [`tokens.json`](/brand/v2.1.1/downloads/tokens/tokens.json) | JSON | Build pipelines, Style Dictionary |
| [`tailwind.config.js`](/brand/v2.1.1/downloads/tokens/tailwind.config.js) | JS | Tailwind CSS projects |

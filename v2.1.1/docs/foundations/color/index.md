...
[the code-comment token](/brand/v2.1.1/docs/interface/code/) for a worked
example.
</div>
...
[Terminal theming page](/brand/v2.1.1/docs/themes/terminal/).
...
[`code-comment` token](/brand/v2.1.1/docs/interface/code/): when no existing
...
- **Direct labelling with one highlight.** Draw every series in `slate-7`, draw
  ...
  [deck](/brand/v2.1.1/docs/media/presentations/) — one idea per slide holds
  for charts too.
...
[table numerics are](/brand/v2.1.1/docs/interface/components/): digits have
...
[Dark mode](/brand/v2.1.1/docs/interface/dark-mode/) for the implementation

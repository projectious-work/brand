...
| | Source |
|---|---|
| **Resume / CV** | [`brand/examples/resume.dc.html`](/brand/v2.1.1/downloads/examples/resume.dc.html) |
...
[signature](/brand/v2.1.1/docs/collateral/email-signature/) makes, on a bigger
sheet.
...
[status vocabulary](/brand/v2.1.1/docs/portfolio/status/) applies — a document

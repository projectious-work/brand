...
on [Colour](/brand/v2.1.1/docs/foundations/color/), the 44px touch floor on
[Responsive](/brand/v2.1.1/docs/foundations/responsive/), the focus trap on
...
[page shell](/brand/v2.1.1/docs/interface/patterns/) is therefore authored as
...
[stacked mobile layout](/brand/v2.1.1/docs/foundations/responsive/) exposes:
...
<div class="pj-demo"><div class="pj-demo__label">Focus ring — 2px accent, 2px offset, on both surfaces</div>
...
[Icons](/brand/v2.1.1/docs/interface/icons/).
...
[Multi-level headers](/brand/v2.1.1/docs/interface/components/) need
`scope="colgroup"` on the group row.

## Motion and preference

The [motion rules](/brand/v2.1.1/docs/foundations/space-shape-motion/) are an

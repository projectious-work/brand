...
[Components](/brand/v2.1.1/docs/interface/components/) answers "what does a
...
the screen — [one accent per view](/brand/v2.1.1/docs/interface/components/)
...
pattern; see [Responsive](/brand/v2.1.1/docs/foundations/responsive/).
...
Each card is a [`pj-stat`](/brand/v2.1.1/docs/interface/components/) — the
...
- **Primary** is the record set — a [table](/brand/v2.1.1/docs/interface/components/)
...
[**Dashboard mockup**](/brand/v2.1.1/downloads/examples/dashboard.dc.html) — a client
...
[44px floor](/brand/v2.1.1/docs/foundations/responsive/) applies regardless.

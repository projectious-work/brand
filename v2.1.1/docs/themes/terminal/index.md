...
The palette is defined in the [Colour foundations](/brand/v2.1.1/docs/foundations/color/)
...
from a stylesheet. Since the [syntax roles](/brand/v2.1.1/docs/interface/code/) were
...
[Colour](/brand/v2.1.1/docs/foundations/color/).

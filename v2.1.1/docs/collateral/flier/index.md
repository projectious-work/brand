...
| | Source |
|---|---|
| **Service flier** | [`brand/examples/flier.dc.html`](/brand/v2.1.1/downloads/examples/flier.dc.html) — "Cloud migration accelerator" |
...
deck](/brand/v2.1.1/docs/media/presentations/), for the same reason.
...
[Lucide](/brand/v2.1.1/docs/interface/icons/) at 20px inside a 40px tile
...
[portfolio principle](/brand/v2.1.1/docs/portfolio/status/) — make maturity
...
same [4.72:1 rule](/brand/v2.1.1/docs/interface/components/) as the interface
and the [email](/brand/v2.1.1/docs/collateral/email/).
...
template](/brand/v2.1.1/docs/portfolio/documents/).
...
- For volume print, hand the vendor the
  [CMYK values](/brand/v2.1.1/docs/collateral/business-card/) rather than the
  hex.

...
**Status:** pending
**aibox CLI:** v0.27.1 → v0.27.2
**processkit:** v0.27.0

## Summary

aibox has been updated from v0.27.1 to v0.27.2. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.27.1 and v0.27.2 is listed below.                  Review each; treat entries tagged as breaking as action items.

  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        bodyL: ['16px', { lineHeight: '1.65', fontWeight: '400' }],
      ...
      boxShadow: {
        ...
        1: '0 1px 3px rgba(0,0,0,0.06)',   // Subtle lift — cards at rest
        2: '0 4px 12px rgba(0,0,0,0.08)',   // Raised — hover, dropdowns
        3: '0 8px 24px rgba(0,0,0,0.12)',   // Overlay — modals, popovers
      },
      transitionDuration: {
        micro: '100ms',
        standard: '200ms',
